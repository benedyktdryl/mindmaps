export const MERMAID_FLOW_CHART = `graph LR
0(Root) --- 1(child1)
1(child1) --- 2(child1-2)
1(child1) --- 3(child1-3)`;

export const MERMAID_FLOW_CHART_WITH_ARROW_CONNECTIONS = `graph LR
0(Root)-->1(child1)
1(child1)-->2(child1-2)
1(child1)-->3(child1-3)`;

export const MERMAID_FLOW_CHART_WITH_ONE_NODE = `graph LR
0(Root)`;

export const MERMAID_FLOW_CHART_WITH_TB_DIRECTION = `graph TB
0(Root)`;

export const MERMAID_FLOW_CHART_WITH_RECTANGULAR_SHAPE = `graph TB
0[Root]`;
